...
const $$NavBar = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$NavBar;
  return renderTemplate`${maybeRenderHead()}<nav data-astro-cid-ymhdp2rl> <div id="navBar" data-astro-cid-ymhdp2rl> <div id="menu" data-astro-cid-ymhdp2rl>Menu</div> <div id="bland" data-astro-cid-ymhdp2rl>P. SHIKAMUSENGE.</div> <div id="links" class="links" data-astro-cid-ymhdp2rl> <a href="#home" data-astro-cid-ymhdp2rl>Home</a> <a href="#about" data-astro-cid-ymhdp2rl>About</a> <a href="#award" data-astro-cid-ymhdp2rl>Awards</a> <a href="#experiences" data-astro-cid-ymhdp2rl>Experience</a> <a href="#contact" data-astro-cid-ymhdp2rl>Contact Us</a> <a href="#portfolio" data-astro-cid-ymhdp2rl>Portfolio</a> </div> <div data-astro-cid-ymhdp2rl> <button data-astro-cid-ymhdp2rl> <a href="mailto:shikamusenge720@gmail.com?cc=codeexp77@gmail.com&subject=You%20are%20hired" style="color: white; text-decoration: none;" target="_blank" rel="noopener noreferrer" data-astro-cid-ymhdp2rl>Hire me</a> </button> </div> </div> </nav>  `;
...
const $$Experience = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section id="experiences" data-astro-cid-xpq65ryk> <div class="container" data-astro-cid-xpq65ryk> <h1 data-astro-cid-xpq65ryk>My Experiences</h1> <ul data-astro-cid-xpq65ryk> <li data-astro-cid-xpq65ryk> <h2 class="company" data-astro-cid-xpq65ryk>TYAZA Limited</h2> <p class="position" data-astro-cid-xpq65ryk>Software Developer & Financial Manager</p> <p class="status" data-astro-cid-xpq65ryk>Current</p> </li> <li data-astro-cid-xpq65ryk> <h2 class="company" data-astro-cid-xpq65ryk>IDA TECHNOLOGY</h2> <p class="position" data-astro-cid-xpq65ryk>Software Developer Intern</p> <p class="status" data-astro-cid-xpq65ryk>September 2023 - October 2023</p> </li> <li data-astro-cid-xpq65ryk> <h2 class="company" data-astro-cid-xpq65ryk>KIBUNGO Level II Teaching Hospital</h2> <p class="position" data-astro-cid-xpq65ryk>ITC Officer Intern</p> <p class="status" data-astro-cid-xpq65ryk>Current</p> </li> </ul> </div> </section>`;
